...
export function showResumeViewer(title, content) {
    ...
    const header = el("div", { className: "resume-viewer-header" }, el("h2", { className: "resume-viewer-title" }, title), el("div", { className: "resume-viewer-actions" }, exportBtn, closeBtn));
